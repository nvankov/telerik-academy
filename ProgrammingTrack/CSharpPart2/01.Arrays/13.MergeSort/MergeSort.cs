...
namespace _13.MergeSort
{
    class MergeSort
    {
        static void Main(string[] args)
        {
            ...
            //a variable to hold the lenght of the subarrays to be sorted at any given moment, at the beginning it is one, as we compere arrays of one elemnt each
            int currentLength = 1;
            ...
            {
                //A loop that go over the elements of the initial array. The step, at which i increases depends on the variable currentLenght, so at the first cycle of the while loop we compare adjacent elements, than the first elements of adjacent pairs, than the first elements of adjacent quadruplets etc.
